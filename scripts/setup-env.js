...
async function setupEnvironment() {
  console.log("🚀 Welcome to Eboni Dating Environment Setup!\n")
  ...
  envVars.JWT_SECRET =
    (await askQuestion("Enter JWT Secret (32+ characters): ")) ||
  ...
  envVars.NEXT_PUBLIC_SITE_URL =
    (await askQuestion("Enter your site URL (e.g., https://your-app.vercel.app or https://your-app.replit.app): ")) ||
    "http://localhost:5000"
